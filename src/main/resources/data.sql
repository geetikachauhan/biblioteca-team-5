insert into book(title , author , year_published , available) values ('A Game of Thrones','George R. R. Martin',1996,true);
insert into book(title , author , year_published , available) values('The Fellowship of the Ring','J. R. R. Tolkien',1954,true);
